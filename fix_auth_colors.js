...
const replaceColors = (content) => {
    ...
    code = code.replace(/bg-blue-100/g, "bg-[var(--neo-primary)]\/10/g", "bg-[var(--neo-primary)]/10");
    code = code.replace(/text-blue-100/g, "text-[var(--neo-primary)]\/10/g", "text-[var(--neo-primary)]/10");
    
    code = code.replace(/bg-blue-50/g, "bg-[var(--neo-primary)]\/5/g", "bg-[var(--neo-primary)]/5");
    code = code.replace(/text-blue-50/g, "text-[var(--neo-primary)]\/5/g", "text-[var(--neo-primary)]/5");
