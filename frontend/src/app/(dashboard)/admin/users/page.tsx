  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-black text-gray-900">مدیریت کاربران</h1>
          <p className="text-gray-500 mt-1">نمایش و مدیریت تمام کاربران سیستم</p>
        </div>
      </div>
            ...
            <table className="w-full text-right">
              <thead>
                <tr className="border-b border-gray-100 bg-gray-50/50">
                  <th className="p-4 font-bold text-gray-600 text-sm">کاربر</th>
                  <th className="p-4 font-bold text-gray-600 text-sm">ایمیل</th>
                  <th className="p-4 font-bold text-gray-600 text-sm">نقش</th>
              ...
              <tbody>
                {filteredUsers.map((user: any) => (
                  <tr key={user._id} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="p-4">
                      <span className="px-2 py-1 bg-gray-100 text-gray-700 rounded-md text-xs font-bold capitalize">
