...
export default function AdminStudentsPage() {
  ...
  // Assuming students have role 'student' or missing role (default)
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-3">
          <div className="p-3 bg-blue-100 text-[var(--neo-primary)] rounded-xl"><GraduationCap className="w-6 h-6" /></div>
          <div>
            <h1 className="text-2xl font-black text-[var(--neo-text-main)]">دانشجویان</h1>
            <p className="text-[var(--neo-text-secondary)] mt-1">مدیریت دانشجویان سیستم</p>
          </div>
        </div>
      </div>
