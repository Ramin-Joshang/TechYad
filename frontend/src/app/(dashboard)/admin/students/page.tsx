    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-3">
          <div className="p-3 bg-blue-100 text-blue-600 rounded-xl"><GraduationCap className="w-6 h-6" /></div>
          <div>
            <h1 className="text-2xl font-black text-gray-900">دانشجویان</h1>
            <p className="text-gray-500 mt-1">مدیریت دانشجویان سیستم</p>
          </div>
        </div>
      </div>
