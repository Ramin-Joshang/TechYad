...
export default function AdminDashboard() {
  ...
  const primaryStats = [
    { label: 'کل کاربران', value: (statsData?.totalUsers || 0).toLocaleString(), icon: Users, color: 'bg-blue-500', link: '/admin/users' },
  ...
  const entityStats = [
    { label: 'دانشجویان', value: (statsData?.students || 0).toLocaleString(), icon: GraduationCap, color: 'text-blue-600 bg-blue-50', link: '/admin/students' },
    { label: 'اساتید', value: (statsData?.instructors || 0), icon: Briefcase, color: 'text-indigo-600 bg-indigo-50', link: '/admin/instructors' },
