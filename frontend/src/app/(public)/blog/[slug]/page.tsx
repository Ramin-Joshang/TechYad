          ...
          <div className="p-8 md:p-12 lg:p-16">
            ...
            <div className="mt-12 pt-8 border-t border-[var(--neo-border)] flex flex-col sm:flex-row justify-between items-center gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <button onClick={copyLink} className="w-10 h-10 rounded-full bg-[var(--neo-border)] text-[var(--neo-text-secondary)] flex items-center justify-center hover:scale-110 transition shadow-md" title="کپی لینک">
            ...
            {/* Author Box */}
            <div className="mt-12 pt-8 border-t border-[var(--neo-border)] flex flex-col sm:flex-row gap-6 items-center sm:items-start bg-[var(--neo-primary)]/5/50 p-8 rounded-3xl border border-blue-100">
              <img 
              ...
              <div className="text-center sm:text-right flex-1">
                <h3 className="font-bold text-xl text-[var(--neo-text-main)] mb-1">{article.author?.firstName || 'تیم'} {article.author?.lastName || 'تک‌یاد'}</h3>
                <p className="text-sm font-bold text-[var(--neo-primary)] mb-4">مدرس و نویسنده ارشد</p>
                <p className="text-[var(--neo-text-secondary)] leading-relaxed">
        ...
        <div className="max-w-4xl">
            ...
            <div className="mb-16 bg-gradient-to-l from-blue-900 to-slate-900 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                <div className="flex-1 text-center md:text-right">
                  ...
                  <p className="text-[var(--neo-primary)]/10 text-sm mb-8 max-w-xl leading-relaxed">
                  ...
                  <Link href={`/courses/${relatedCourse.slug}`} className="inline-flex items-center gap-2 bg-[var(--neo-secondary)] hover:bg-blue-400 text-white px-8 py-4 rounded-xl font-bold transition-all shadow-lg shadow-blue-500/30">
          ...
          <div className="bg-white rounded-3xl border border-[var(--neo-border)] p-8 md:p-12 shadow-sm mb-12">
            ...
            <div className="flex gap-4 md:gap-6 mb-12">
              <div className="w-12 h-12 md:w-14 md:h-14 bg-[var(--neo-primary)]/10 text-[var(--neo-primary)] rounded-full flex items-center justify-center shrink-0 font-bold text-lg shadow-inner">
                شما
              </div>
              <div className="flex-1 relative">
                <textarea 
                  ...
                  className="w-full bg-[var(--neo-bg)] border border-[var(--neo-border)] rounded-2xl p-5 text-base focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none shadow-inner"
                ></textarea>
                <div className="flex justify-end mt-3">
                  <button className="bg-[var(--neo-primary)] hover:bg-blue-700 text-white px-6 py-2.5 rounded-xl font-bold transition-colors shadow-md flex items-center gap-2">
            ...
            <div className="space-y-8">
              {[
                ...
                <div key={idx} className="flex gap-4 md:gap-6 pb-8 border-b border-[var(--neo-border)] last:border-0 last:pb-0">
                  <div className="w-12 h-12 md:w-14 md:h-14 bg-[var(--neo-surface-2)] rounded-full flex items-center justify-center shrink-0 text-[var(--neo-text-muted)] font-bold text-xl border border-[var(--neo-border)]">
                    {comment.name.charAt(0)}
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-3">
                      <div>
                        <span className="font-bold text-[var(--neo-text-main)] text-lg">{comment.name}</span>
                        <span className="text-sm text-[var(--neo-text-muted)] block sm:inline sm:mr-3 mt-1 sm:mt-0">{comment.date}</span>
                      </div>
                      <button className="flex items-center gap-1.5 text-sm font-medium text-[var(--neo-text-muted)] hover:text-[var(--neo-primary)] transition bg-[var(--neo-bg)] px-3 py-1.5 rounded-lg border border-[var(--neo-border)]">
                        <ThumbsUp className="w-4 h-4" />
                        <span>{comment.likes}</span>
                      </button>
                    </div>
                    <p className="text-[var(--neo-text-secondary)] text-base leading-relaxed">{comment.text}</p>
                  </div>
                </div>
              ))}
            </div>
