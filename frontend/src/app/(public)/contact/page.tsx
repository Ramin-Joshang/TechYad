  ...
  return (
    <main className="bg-[var(--neo-bg)] min-h-screen py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <ul className="space-y-6">
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-[var(--neo-text-secondary)] text-sm leading-relaxed">
                ...
                <li className="flex gap-4">
                  ...
                  <div>
                    <div className="font-bold text-[var(--neo-text-main)] mb-1">شماره تلفن</div>
                    <div className="text-[var(--neo-text-secondary)] text-sm dir-ltr text-right">۰۲۱-۸۸۸۸۸۸۸۸</div>
                    <div className="text-[var(--neo-text-secondary)] text-sm dir-ltr text-right">۰۹۱۲-۱۲۳۴۵۶۷</div>
                  </div>
                </li>
                <li className="flex gap-4">
                  <div className="w-12 h-12 bg-[var(--neo-primary)]/5 text-[var(--neo-primary)] rounded-2xl flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <div className="font-bold text-[var(--neo-text-main)] mb-1">ایمیل سازمانی</div>
                    <div className="text-[var(--neo-text-secondary)] text-sm">info@techyad.ir</div>
                  </div>
                </li>
                <li className="flex gap-4">
                  <div className="w-12 h-12 bg-[var(--neo-primary)]/5 text-[var(--neo-primary)] rounded-2xl flex items-center justify-center shrink-0">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-sm border border-[var(--neo-border)]">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-bold text-[var(--neo-text-secondary)] mb-2">نام و نام خانوادگی</label>
                    <input 
                      type="text" 
                      required
                      value={formData.name}
                      onChange={e => setFormData({...formData, name: e.target.value})}
                      className="w-full bg-[var(--neo-bg)] border border-[var(--neo-border)] rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500"
                      placeholder="مثال: علی رضایی"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-[var(--neo-text-secondary)] mb-2">شماره موبایل</label>
                    <input 
                      type="tel" 
                      required
                      value={formData.phone}
                      onChange={e => setFormData({...formData, phone: e.target.value})}
                      className="w-full bg-[var(--neo-bg)] border border-[var(--neo-border)] rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 text-left dir-ltr"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-sm font-bold text-[var(--neo-text-secondary)] mb-2">موضوع پیام</label>
                    <select 
                      required
                      value={formData.subject}
                      onChange={e => setFormData({...formData, subject: e.target.value})}
                      className="w-full bg-[var(--neo-bg)] border border-[var(--neo-border)] rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none"
                    >
                ...
                <div>
                  <label className="block text-sm font-bold text-[var(--neo-text-secondary)] mb-2">متن پیام</label>
                  <textarea 
                    required
                    rows={5}
        ...
        {/* Map Placeholder */}
        <div className="bg-[var(--neo-border)] rounded-3xl h-96 flex items-center justify-center overflow-hidden border border-[var(--neo-border)] relative shadow-inner">
