    ...
    <main className="bg-[var(--neo-bg)] min-h-screen">
      ...
      <section className="relative bg-slate-900 text-white overflow-hidden py-24 md:py-32">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
            یادگیری بهتر، <span className="text-[var(--neo-secondary)]">آینده بهتر</span>
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[var(--neo-text-main)] mb-6">داستان ما</h2>
              <p className="text-lg text-[var(--neo-text-secondary)] leading-relaxed mb-6">
              ...
              <p className="text-lg text-[var(--neo-text-secondary)] leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="bg-[var(--neo-primary)]/5 rounded-3xl p-8 border border-blue-100">
      ...
      <section className="py-20 bg-[var(--neo-bg)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-[var(--neo-text-main)] mb-4">حوزه‌های آموزشی ما</h2>
          <p className="text-lg text-[var(--neo-text-secondary)] mb-12 max-w-2xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['دانشگاهی', 'دانش‌آموزی', 'برنامه‌نویسی', 'برق', 'کامپیوتر', 'ریاضی', 'فیزیک', 'طراحی سایت', 'هوش مصنوعی', 'زبان انگلیسی'].map(area => (
              <span key={area} className="px-6 py-3 bg-white rounded-2xl shadow-sm text-[var(--neo-text-main)] font-bold border border-[var(--neo-border)] hover:border-blue-300 hover:shadow-md transition">
                {area}
              </span>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1 grid grid-cols-2 gap-6">
              {[
                ...
                <div key={idx} className="text-center p-8 bg-[var(--neo-bg)] rounded-3xl border border-[var(--neo-border)]">
                  <stat.icon className="w-10 h-10 mx-auto text-[var(--neo-primary)] mb-4" />
                  <div className="text-3xl font-bold text-[var(--neo-text-main)] mb-1">{stat.title}</div>
                  <div className="text-[var(--neo-text-muted)] font-medium">{stat.subtitle}</div>
                </div>
              ))}
            </div>
            <div className="order-1 lg:order-2">
              <h2 className="text-3xl font-bold text-[var(--neo-text-main)] mb-6">چرا تک‌یاد؟</h2>
              <ul className="space-y-4">
                {[
                  ...
                  <li key={idx} className="flex items-start gap-3">
                    ...
                    <span className="text-lg text-[var(--neo-text-secondary)]">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
      ...
      <section className="py-20 bg-[var(--neo-bg)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-[var(--neo-text-main)] mb-12">تیم بنیان‌گذاران</h2>
          <div className="flex flex-wrap justify-center gap-12">
            {[
              ...
              <div key={idx} className="text-center">
                ...
                />
                <h3 className="text-xl font-bold text-[var(--neo-text-main)] mb-1">{member.name}</h3>
                <p className="text-[var(--neo-text-muted)]">{member.role}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* CTA */}
      <section className="py-20 bg-[var(--neo-primary)] text-center px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">آماده‌اید مسیر یادگیری را شروع کنید؟</h2>
        <p className="text-[var(--neo-primary)]/10 text-lg mb-8 max-w-2xl mx-auto">
          همین حالا به جمع دانشجویان تک‌یاد بپیوندید و با شرکت در دوره‌های ما، آینده شغلی خود را تضمین کنید.
        </p>
        <Link href="/courses" className="inline-flex items-center gap-2 bg-white text-[var(--neo-primary)] px-8 py-4 rounded-xl font-bold text-lg hover:bg-[var(--neo-bg)] transition shadow-lg">
